 ...
 * Pixel da Meta.
 *
 * Vai inline no <head> para disparar o PageView antes de qualquer render —
 * pixel carregado tarde perde visita e estraga a atribuição da campanha.
 * Para trocar de conta, mexa só nesta constante.
 */
const META_PIXEL_ID = "1085628327191844";
